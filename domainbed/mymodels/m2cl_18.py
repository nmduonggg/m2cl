...
class M2CL18(nn.Module):
    ...
    def forward_hyper(self, x, collect=False):
        ...
        out1, out1_conv = self.ext_block1(x)

        x = self.bn1_11(x)
        x = self.relu1_11(x)

        x = self.conv1_12(x)
        out2, out2_conv = self.ext_block2(x)
        ...
        out3, out3_conv = self.ext_block3(x)
        ...
        identity = x
        x = self.conv2_11(x)
        out5, out5_conv = self.ext_block5(x)
        ...
        out8, out8_conv = self.ext_block8(x)
        x = self.bn2_22(x)
        ...
        identity = x
        x = self.conv3_21(x)
        out11, out11_conv = self.ext_block11(x)

        x = self.bn3_21(x)
        x = self.relu3_21(x)
        x = self.conv3_22(x)
        out12, out12_conv = self.ext_block12(x)
        ...
        x = self.relu4_11(x)
        x = self.conv4_12(x)
        out14, out14_conv = self.ext_block_14(x)
        ...
        add06_0, add06_0_conv = self.ext_add_block6(x)

        identity = x
        x = self.conv4_21(x)
        out15, out15_conv = self.ext_block15(x)

        x = self.bn4_21(x)
        x = self.relu4_21(x)
        x = self.conv4_22(x)
        out16, out16_conv = self.ext_block16(x)

        x = self.bn4_22(x)

        add7 = identity + x
        x = nn.ReLU(inplace=True)(add7)
        add07_0, add07_conv = self.ext_add_block7(x)
